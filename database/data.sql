...
VALUES
    ('AMD RYZEN 5 3600', 114.99, 'CPU',  'Serious gaming, fully unlocked. Everyone deserves a powerful processor', 10),
    ...
    ('ASRock Radeon RX 5700 XT 8 GB Challenger D OC Video Card', 999.00, 'Graphics_Cards', 'Graphics Engine: AMD Radeon RX 5700 XT Bus Standard: PCI Express 4', 8900),
    ...
    ('External DVD Drive, USB 3.0 Portable CD/DVD+/-RW Drive/DVD Player for Laptop CD ROM Burner Compatible with Laptop Desktop PC Windows Linux OS Apple Mac Black ', 29.99, 'Optical_Drives', 'High Writing and Reading Speed】 Max 8x DVDR Write Speed and Max 24x CD Write Speed provide high writing and reading speed', 5),
    ...
    ('Intel Core i3-10100 3.6 GHz Quad-Core Processor', 199.99, 'CPU',  '4 Cores / 8 Threads', 20);
